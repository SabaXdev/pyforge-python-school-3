import pytest
from main import substructure_search  # Ensure main is the correct name of your module
...
@pytest.mark.parametrize("smiles, substructure, expected", [
    ...
    (["CCO", "c1ccccc1", "CC(=O)O", "CC(=O)Oc1ccccc1C(=O)O"], "CO", ['CCO', 'CC(=O)O', 'CC(=O)Oc1ccccc1C(=O)O']),
